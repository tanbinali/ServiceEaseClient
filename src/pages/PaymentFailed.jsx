  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-base-100 p-4">
      <div className="max-w-md w-full bg-base-200 rounded-xl shadow-lg p-8 text-center">
        ...
        <Link
          to="/dashboard/orders"
          className="inline-flex items-center justify-center gap-2 bg-error text-error-content hover:bg-error-focus font-medium rounded-lg px-6 py-3 transition-colors w-full"
        >
